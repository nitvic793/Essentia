...
es::Binding::GetInstance().BindMethod(#module, #className, #field "=(_)" , false, _VM_ ## name ## Set ## field); \
es::Binding::GetInstance().BindMethod(#module, #className, #field, false, _VM_ ## name ## Get ## field) 
